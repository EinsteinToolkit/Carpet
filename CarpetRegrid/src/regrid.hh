...
int BaseLevel(cGH const *const cctkGH, gh const &hh, gh::rregs &regss);

int Centre(cGH const *const cctkGH, gh const &hh, gh::rregs &regss);

int ManualGridpoints(cGH const *const cctkGH, gh const &hh, gh::rregs &regss);
...
void Automatic_OneLevel(const cGH *const cctkGH, const gh &hh, const int rl,
                        const int numrl, const gf<CCTK_REAL> &errorvar,
