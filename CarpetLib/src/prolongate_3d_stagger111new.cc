...
#define DSTOFF3(i,j,k)                          \
  ...
  namespace coeffs_3d_stagger111 {
    ...
    test ()
    {
      ...
      for (int n=0; n<=ORDER; ++n) {
        ...
        if (not (fabs (res - y0) < eps)) {
          RT rt;
          ostringstream buf;
          buf << "Error in prolongate_3d_rf2::coeffs_3d_stagger111\n"
              << "   RT=" << typestring(rt) << "\n"
              << "   ORDER=" << ORDER << "\n"
              << "   n=" << n << "\n"
              << "   y0=" << y0 << ", res=" << res;
...
#undef TYPECASE
    ...
    extern "C"
    void CarpetLib_test_prolongate_3d_stagger111 (CCTK_ARGUMENTS)
    {
...
#undef TYPECASE
  ...
  using namespace coeffs_3d_stagger111;
...
#define TYPECASE(N,T)                                           \
  ...
  template                                                      \
  void                                                          \
  prolongate_3d_stagger111<T,1> (T const * restrict const src,         \
                          ivect3 const & restrict srcpadext,    \
                          ivect3 const & restrict srcext,       \
                          T * restrict const dst,               \
                          ivect3 const & restrict dstpadext,    \
  ...
  template                                                      \
  void                                                          \
  prolongate_3d_stagger111<T,5> (T const * restrict const src,         \
                          ivect3 const & restrict srcpadext,    \
                          ivect3 const & restrict srcext,       \
                          T * restrict const dst,               \
                          ivect3 const & restrict dstpadext,    \
  ...
  template                                                      \
  void                                                          \
  prolongate_3d_stagger111<T,7> (T const * restrict const src,         \
                          ivect3 const & restrict srcpadext,    \
                          ivect3 const & restrict srcext,       \
                          T * restrict const dst,               \
                          ivect3 const & restrict dstpadext,    \
  ...
  template                                                      \
  void                                                          \
  prolongate_3d_stagger111<T,9> (T const * restrict const src,         \
                          ivect3 const & restrict srcpadext,    \
                          ivect3 const & restrict srcext,       \
                          T * restrict const dst,               \
                          ivect3 const & restrict dstpadext,    \
  ...
  template                                                      \
  void                                                          \
  prolongate_3d_stagger111<T,11> (T const * restrict const src,        \
                           ivect3 const & restrict srcpadext,   \
                           ivect3 const & restrict srcext,      \
                           T * restrict const dst,              \
                           ivect3 const & restrict dstpadext,   \
