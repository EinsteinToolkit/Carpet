...
// interpolation.
  ...
  template <typename T>
                          ...
                          size_t const d1, size_t const d2)
    {
      ...
      RT const f2 = 3/den, f1 = 25/den, f0 = 150/den;
      T const res =
        + f2 * restrict1 (p - 2*d2, d1)
        - f1 * restrict1 (p - 1*d2, d1)
        + f0 * restrict1 (p - 0*d2, d1)
        + f0 * restrict1 (p + 1*d2, d1)
        - f1 * restrict1 (p + 2*d2, d1)
        + f2 * restrict1 (p + 3*d2, d1);
      return res;
    }
  ...
  template <typename T>
                          ...
                          size_t const d1, size_t const d2, size_t const d3)
    {
      ...
      RT const f2 = 3/den, f1 = 25/den, f0 = 150/den;
      T const res =
        + f2 * restrict2 (p - 2*d3, d1, d2)
        - f1 * restrict2 (p - 1*d3, d1, d2)
        + f0 * restrict2 (p - 0*d3, d1, d2)
        + f0 * restrict2 (p + 1*d3, d1, d2)
        - f1 * restrict2 (p + 2*d3, d1, d2)
        + f2 * restrict2 (p + 3*d3, d1, d2);
      return res;
    }
