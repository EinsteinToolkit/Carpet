...
{\tt PeriodicCarpet} applies periodic boundary conditions to Carpet
grids. In particular, it provides correct behaviour for the case
where a refinement level overlaps the periodic boundaries, and 
may therefore be made up of more than one component on the same
process. Thorn {\tt Periodic}, by constrast, will not handle this case
properly. 
